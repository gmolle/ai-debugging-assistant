...
export function CodeMirrorField({
  ...
  return (
    <div
      className={`overflow-hidden rounded-lg border border-slate-700 bg-[#1e1e1e] focus-within:border-emerald-600/60 focus-within:ring-1 focus-within:ring-emerald-600/40 ${className}`}
    >
      <CodeMirror
        value={value}
        height={height}
